...
Please note that the full implementation can also be found in the public repository referenced in \cite{repository}.
...
Each actor can be in a crashed or launched state. If it is crashed, it will not respond to any
...
\bibitem{repository}
A. Kabil, D. Famà, E. Barau, T. Marculescu.
``Robust Key-Value Store Implementation.''
\url{
    https://github.com/marcutudor79/robust-key-value-store
}
